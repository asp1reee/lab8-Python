...
def track_marker(frame):
    ...
    circles = cv2.HoughCircles(
        blurred, cv2.HOUGH_GRADIENT, dp=1, minDist=50, param1=100,
    ...
    top_left = (square_center[0] - square_size // 2,
                square_center[1] - square_size // 2)
    bottom_right = (square_center[0] + square_size // 2,
                    square_center[1] + square_size // 2)
    ...
    if circles is not None:
        ...
        for (x, y, r) in circles:
            ...
            if (top_left[0] < x < bottom_right[0]) and (
                ...
                cv2.putText(
                    frame, "Marker inside the square", (x - 50, y - r - 10),
